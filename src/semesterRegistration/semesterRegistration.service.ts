...
import academicSemester from "../app/modules/academic/academic.model";
...
const createSemesterRegistrationIntoDB = async (
  ...
  // Step2: Check if the semester exists (validate ObjectId)
  if (!mongoose.Types.ObjectId.isValid(academicSemesterId)) {
    throw new appError(httpStatus.BAD_REQUEST, "Invalid academic semester ID!");
  }
  ...
  const isSemesterRegistrationExists = await SemesterRegistration.findOne({
    academicSemester: academicSemesterId, // Correct reference to the ObjectId
  });
...
//   const academicSemesterId = payload?.academicSemester;
//   console.log(typeof academicSemesterId);
